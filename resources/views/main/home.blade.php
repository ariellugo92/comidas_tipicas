    ...
    @else
        <div class="center">
            ...
            @if(session()->has('user_conectado'))
                <p class="center">
                    <a href="/recetas/form/comida/agregar" class="btn">Agregar Receta De Comida</a>
                    <a href="/recetas/form/comida/agregar" class="btn">Agregar Receta De Bebida</a>
                    <a href="/recetas/form/comida/agregar" class="btn">Agregar Receta De Postre</a>
                </p>
            @endif
        </div>
    @endif
